const frases = [
  ...
  { frase: "Debo aceptar que nunca serás mía ,es hora de ponerle punto final a esta historia,escribirte es escribirle a la nada por que hasta las palabras se cansan de nunca ser leídas o escuchadas y esta noche están de luto...tu poeta ha muerto.", autor: "Charles Bukowski" },
];
...
setInterval(cambiarFrase, 30000); // Cambiar la frase cada 15 segundos
